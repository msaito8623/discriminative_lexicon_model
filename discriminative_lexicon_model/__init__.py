...
try:
    ...
    from . import ldl
    from . import path_weaving
    from .mapping import *
    from .measures import *
    from .performance import *
    from .ldl import *
    from .path_weaving import *
except ModuleNotFoundError:
    pass

__all__ = ["mapping", "measures", "performance", "ldl", "path_weaving"]
for _mod in (mapping, measures, performance, ldl, path_weaving):
